...
import { createPost, deletePost, getAllComments, getAllPosts, postComment, incrementPostLike} from '@/config/redux/action/postAction';
...
},[authState.profileFetched, authState.all_profiles_fetched])
   ...
   <DashboardLayout>
    <div className={styles.scrollComponent}>
      ...
      <div className={styles.createPostContainer}>
        <img className={styles.userProfile} src={
          authState.user?.userId?.profilePicture?
          `${BASE_URL}/uploads/${authState.user.userId.profilePicture}`: "/"} alt="" />
    ...
    <div style={{flex: 1}}>
      ...
      <div style={{display: "flex", gap: "1.2rem", justifyContent: "space-between"}}>
        ...
        {post.userId?._id === authState.user.userId._id &&
          <div onClick={async () => {
            ...
            <svg style={{height: "1.4rem", color: "red"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className={styles.optionsContainer}>
        ...
        <div onClick={async () => {
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{height: "1.4rem"}}>
        ...
        <div onClick={async () => {
          ...
          console.log("PostId set:", post._id)
        }} className={styles.singleOption__optionsContainer}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{height: "1.4rem"}}>
        ...
        <div onClick={() => {
          ...
          const url = encodeURIComponent("@princemaurya70")
          const twitterUrl = `https://twitter.com/intent/tweet?text=${text}&url=${url}`;
          window.open(twitterUrl, '_blank') // yeh line bhi missing thi!
        }} className={styles.singleOption__optionsContainer}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{height: "1.4rem"}}>
      ...
      <div onClick={()=>{
        ...
        onClick={(e)=>{
         ...
         className={styles.allCommentsContainer}>
          {postState.comments?.length ===0 && <h2>
            No Comments</h2>}
            ...
            <div>
              ...
              <div className={styles.singleComment} key={postComment._id}>
                ...
                <div>
                <p style={{ fontWeight: "bold", fontSize : "1.rem"}}>{postComment.userId.username}</p>
